...
export type LessonManyWhereInput = {
  ...
  /** Contains search across all appropriate fields. */
  _search?: InputMaybe<Scalars['String']>;
  avaliableAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  avaliableAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
  avaliableAt_gte?: InputMaybe<Scalars['DateTime']>;
  /** All values that are contained in given list. */
  avaliableAt_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']>>>;
  /** All values less than the given value. */
  avaliableAt_lt?: InputMaybe<Scalars['DateTime']>;
  /** All values less than or equal the given value. */
  avaliableAt_lte?: InputMaybe<Scalars['DateTime']>;
  /** All values that are not equal to given value. */
  avaliableAt_not?: InputMaybe<Scalars['DateTime']>;
  /** All values that are not contained in given list. */
  avaliableAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']>>>;
  createdAt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than the given value. */
  createdAt_gt?: InputMaybe<Scalars['DateTime']>;
  /** All values greater than or equal the given value. */
...
export enum LessonOrderByInput {
  AvaliableAtAsc = 'avaliableAt_ASC',
  AvaliableAtDesc = 'avaliableAt_DESC',
  CreatedAtAsc = 'createdAt_ASC',
  CreatedAtDesc = 'createdAt_DESC',
...
export type ScheduledOperationAffectedDocument = Asset | Lesson | Subscriber | Teacher;
